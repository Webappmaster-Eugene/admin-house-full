...
export interface IGlobalCategoryMaterialController
  ...
  getAllEP: (urlParams: IUrlParams) => Promise<GlobalCategoryMaterialGetAllResponseDto>;
  createEP: (dto: GlobalCategoryMaterialCreateRequestDto, urlParams: IUrlParams) => Promise<GlobalCategoryMaterialCreateResponseDto>;
  updateByIdEP: (
