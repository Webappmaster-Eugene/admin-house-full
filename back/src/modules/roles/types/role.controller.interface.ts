...
export interface IRoleController
  ...
  getByValueEP: (roleName: EUserTypeVariants, urlParams: IUrlParams) => Promise<RoleGetResponseDto>;
  getAllEP: (urlParams?: IUrlParams, queryParams?: IQueryParams) => Promise<RoleGetAllResponseDto>;
