...
export interface IWorkspaceController
  ...
  > {
  getByIdEP: (workspaceId: EntityUrlParamCommand.RequestUuidParam, urlParams: IUrlParams) => Promise<WorkspaceGetResponseDto>;
  getAllEP: (urlParams: IUrlParams, queryParams?: IQueryParams) => Promise<WorkspaceGetAllResponseDto>;
  createEP: (dto: WorkspaceCreateRequestDto, urlParams: IUrlParams, userInfoFromJWT: IJWTPayload) => Promise<WorkspaceCreateResponseDto>;
  updateByIdEP: (
    workspaceId: EntityUrlParamCommand.RequestUuidParam,
    dto: WorkspaceUpdateRequestDto,
    urlParams: IUrlParams,
  ) => Promise<WorkspaceUpdateResponseDto>;
  deleteByIdEP: (workspaceId: EntityUrlParamCommand.RequestUuidParam, urlParams: IUrlParams) => Promise<WorkspaceDeleteResponseDto>;
