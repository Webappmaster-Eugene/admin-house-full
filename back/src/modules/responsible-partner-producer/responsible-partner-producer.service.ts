...
@Injectable()
export class ResponsiblePartnerProducerService
  implements IResponsiblePartnerProducerService
{
  constructor(
    @Inject(KEYS_FOR_INJECTION.I_RESPONSIBLE_PARTNER_PRODUCER_REPOSITORY)
  ...
  async getById(
    ...
    const findedResponsiblePartnerProducer =
      await this.responsiblePartnerProducerRepository.getById(
        responsiblePartnerProducerId,
      );
    return new InternalResponse<ResponsiblePartnerProducerEntity>(
  ...
  > {
    const allResponsiblePartnerProducers =
      await this.responsiblePartnerProducerRepository.getAll();
    return new InternalResponse<ResponsiblePartnerProducerEntity[]>(
  ...
  async create(
    ...
    const createdResponsiblePartnerProducer =
      await this.responsiblePartnerProducerRepository.create(dto, managerId);
    return new InternalResponse<ResponsiblePartnerProducerEntity>(
      createdResponsiblePartnerProducer,
    );
  }
  ...
  async updateById(
    ...
    const updatedResponsiblePartnerProducer =
      await this.responsiblePartnerProducerRepository.updateById(
        responsiblePartnerProducerId,
        dto,
      );
    return new InternalResponse<ResponsiblePartnerProducerEntity>(
  ...
  async deleteById(
    ...
    const deletedResponsiblePartnerProducer =
      await this.responsiblePartnerProducerRepository.deleteById(
        responsiblePartnerProducerId,
      );
    return new InternalResponse<ResponsiblePartnerProducerEntity>(
