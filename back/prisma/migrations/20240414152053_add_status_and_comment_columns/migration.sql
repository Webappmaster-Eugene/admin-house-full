...
-- CreateIndex
CREATE UNIQUE INDEX "organization_organization_leader_uuid_key" ON "organization"("organization_leader_uuid");
...
-- AddForeignKey
ALTER TABLE "field_of_category" ADD CONSTRAINT "field_of_category_category_uuid_fkey" FOREIGN KEY ("category_uuid") REFERENCES "category_material"("uuid") ON DELETE CASCADE ON UPDATE CASCADE;
