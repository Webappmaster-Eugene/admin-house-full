...
// import { fieldsOfCategoryMaterialsCreateHandler } from '@/utils/table-handlers/fields-of-category-materials/fields-of-category-materials-create.handler';
...
//       flex: fieldsOfCategoryMaterialsDataGridInitialState?.columns?.dimensions?.name?.width
//         ? undefined
//         : 1,
//       align: 'left',
//       headerAlign: 'left',
...
//     },
//     {
//       field: FieldOfCategoryMaterialColumnSchema.namePublic,
//       headerName: 'Сокращенно',
//       minWidth: 170,
//       width: fieldsOfCategoryMaterialsDataGridInitialState?.columns?.dimensions?.namePublic?.width,
//       align: 'left',
//       headerAlign: 'left',
//       editable: true,
//       // renderHeader: (params) => (
...
//     },
//     {
//       field: FieldOfCategoryMaterialColumnSchema.price,
//       valueFormatter: (value) => toRubles(Number(value)),
//       headerName: 'Цена',
//       minWidth: 140,
//       width: fieldsOfCategoryMaterialsDataGridInitialState?.columns?.dimensions?.price?.width,
//       type: 'number',
//       align: 'left',
//       headerAlign: 'left',
//       editable: true,
...
//     },
//     {
//       field: FieldOfCategoryMaterialColumnSchema.sourceInfo,
//       // flex: 1,
...
//       },
//       minWidth: 150,
//       width: fieldsOfCategoryMaterialsDataGridInitialState?.columns?.dimensions?.sourceInfo?.width,
//       align: 'left',
//       headerAlign: 'left',
//       editable: true,
//       // renderHeader: (params) => (
...
//       minWidth: 110,
//       width:
//         fieldsOfCategoryMaterialsDataGridInitialState?.columns?.dimensions?.responsiblePartner
//           ?.width,
//       align: 'left',
//       headerAlign: 'left',
//       editable: true,
...
//       minWidth: 100,
//       width:
//         fieldsOfCategoryMaterialsDataGridInitialState?.columns?.dimensions?.categoryMaterial?.width,
//       editable: true,
//       type: 'singleSelect',
//       valueOptions: (params) => {
//         const categories =
...
//       minWidth: 100,
//       width:
//         fieldsOfCategoryMaterialsDataGridInitialState?.columns?.dimensions?.unitMeasurement?.width,
//       editable: true,
//       type: 'singleSelect',
//       valueOptions: (params) => {
...
//       minWidth: 130,
//       width:
//         fieldsOfCategoryMaterialsDataGridInitialState?.columns?.dimensions?.priceChanges?.width,
//       align: 'left',
//       headerAlign: 'left',
//     },
//     {
