...
export const NavData: NavItems = [
  // MAIN MENU
  {
    ...
    items: [
      ...
      {
        title: 'Организации',
        titleShort: 'Организации',
        caption: 'Компании, в которых ведутся проекты',
        captionFull: 'Организации: компании, от имени которых ведутся проекты и сметы',
      ...
      },
      {
        title: 'Проекты',
        titleShort: 'Проекты',
        caption: 'Объекты заказчиков',
        captionFull: 'Проекты: объекты заказчиков, в которых составляются сметы',
