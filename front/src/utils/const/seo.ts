...
export const SITE_TITLE_DEFAULT = 'SMETAS — строительные сметы из своего справочника цен';

// До ~160 символов — длиннее поисковики обрезают сниппет.
export const SITE_DESCRIPTION =
  'Справочник цен на материалы и работы, готовые расценки, расчёт себестоимости и цены для заказчика, выгрузка сметы в Excel.';
