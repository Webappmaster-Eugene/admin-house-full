...
import { paper } from 'src/shared/components/theme/css';
import { BaseOptions } from 'src/shared/components/settings/drawer/base-option';
import { LayoutOptions } from 'src/shared/components/settings/drawer/layout-options';
import { StretchOptions } from 'src/shared/components/settings/drawer/stretch-options';
import { PresetsOptions } from 'src/shared/components/settings/drawer/presets-options';
import { FullScreenOption } from 'src/shared/components/settings/drawer/fullscreen-option';
